                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarDefault">
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-2 align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link fw-bold inner-items-center text-secondary" id="active-nav" href="/schoolwala"><img class="nav-img" src="{{asset('./icon/graduation.png')}}" width="19" />&nbsp;<span>Schoolwala</span></a>
                                </li>
                                                                <li class="nav-item">
                            ...
                            <section class="video-fixed-section">
                                <div class="shadow border p-3 vfs-inner bg-white h-100">
                                    <div style="border-radius: 15px; overflow: hidden;" class="img-container bg-black shadow-sm">
                                        <iframe 
                                            width="100%" 
                                            src="https://www.youtube.com/embed/yC-ToWidSsE?autoplay=1&mute=1&loop=1&playlist=yC-ToWidSsE&controls=0&modestbranding=1" 
                                            frameborder="0" 
